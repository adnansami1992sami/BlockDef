"""
Django settings for defense project.
...
SECRET_KEY = 'euzh4n0uv+9)3v^u3m@lncazq5@pe^&1^vd_8p=wtvef_t$sb4'

ENCRYPT_KEY = 'AiMCduXlQ0S5gLbqfL07ExVnIvGCHBVgHO3Tlj-m8JY='
...
AUTH_USER_MODEL = 'defense.CustomUser'
